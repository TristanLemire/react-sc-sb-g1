...
const TwitchIcon = props => {
  ...
  return (
    <>
      { icon === "star" && 
      <svg color={color} icon={icon} width="28" height="26" viewBox="0 0 28 26" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        icon === "starBadge" &&
        <svg color={color} icon={icon} width="28" height="22" viewBox="0 0 28 22" xmlns="http://www.w3.org/2000/svg">
